...
public class MainActivityUserProfile extends AppCompatActivity {
    ...
    private void readData() {
        ...
        databaseReference.child("USERS").orderByChild("Name").addValueEventListener(new ValueEventListener() {
            @SuppressLint("NotifyDataSetChanged")
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                userProfileEntityArrayList.clear();
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    UserProfileEntity users = dataSnapshot.getValue(UserProfileEntity.class);
                    userProfileEntityArrayList.add(users);
                }
            ...
            buttonAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (name.isEmpty() || age.isEmpty() || gender.isEmpty() || occupation.isEmpty() || email.isEmpty()) {
                        ...
                        databaseReference.child("USERS").child(id).setValue(new UserProfileEntity(id, name, age, gender,occupation,email));
